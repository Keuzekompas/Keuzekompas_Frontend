      ...
      {showSettings && (
        <div className="relative" ref={settingsRef}>
          <button 
            ...
            className="cursor-pointer p-1 rounded-full hover:bg-(--bg-input) focus:outline-none"
            aria-label="Settings"
          ...
          {isSettingsOpen && (
            <div className="absolute right-0 mt-2 w-64 bg-(--bg-card) rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 z-50 p-4 border border-(--border-divider)">
              ...
              {/* Logout */}
              <button onClick={handleLogout} className="w-full flex items-center px-2 py-2 text-sm btn-danger rounded-md">
